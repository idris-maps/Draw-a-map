...
},{"./featureStyle.js":1,"./menu.js":3,"browserify-zepto":9,"leaflet":11}],3:[function(require,module,exports){
var $ = require('browserify-zepto');
...
},{"./map.js":2,"./secCtrl.js":5,"./txt.json":6,"./views.js":7,"browserify-zepto":9}],4:[function(require,module,exports){
var $ = require('browserify-zepto');
var txt = require('./txt.json');
var menu = require('./menu.js');
var L = require('leaflet');
...
},{"./menu.js":3,"./txt.json":6,"./views.js":7,"browserify-zepto":9,"leaflet":11}],5:[function(require,module,exports){
var $ = require('browserify-zepto');
var txt = require('./txt.json');
var menu = require('./menu.js');
...
},{"./menu.js":3,"./txt.json":6,"browserify-zepto":9}],6:[function(require,module,exports){
module.exports={
	en: {
		colorOptions : [
			{ name: 'Blue', id: 'Blue'},
		...
		draw: {
			menu: {
				index: {
					...
					color: 'color',
					del: 'delete',
					drawPoint: 'Click the map to add a point',
					drawLine: 'Click the map to add a line',
					drawPolygon: 'Click the map to add a polygon',
					dlTitle: 'Download geojson file',
					dl: 'Download',
					upTitle: 'Upload geojson file'
				},
				confirmPoint : {
					nameText: 'Give this point a name',
					namePlaceholder: 'Name',
					colorText: 'Choose a marker color',
					confirm: 'OK',
					cancel: 'Cancel'
				},
				confirmLine : {
					nameText: 'Give this line a name',
					namePlaceholder: 'Name',
				...
				confirmPolygon : {
					nameText: 'Give this polygon a name',
					namePlaceholder: 'Name',
					colorText: 'Choose a color',
					confirm: 'OK',
					cancel: 'Cancel'
				...
				edit: {
					titleName: 'Change the name of this element:',
					name: 'NAME',
					newname: 'New name',
					cancel: 'Cancel',
					okName: 'Change the name',
					titleCol: 'Change the color of this element:',
					okCol: 'Change the color'
				},
				changeName: {
					title: 'Change the name of this element:',
					name: 'NAME',
					newname: 'New name',
					cancel: 'Cancel',
					ok: 'Change the name'
				...
				changeStyle: {
					title: 'Change the color of this element:',
					name: 'NAME',
					cancel: 'Cancel',
					ok: 'Change color'
				}
		...
		draw: {
			menu: {
				index: {
					...
					line: 'une ligne',
					polygon: 'un polygone',
					list: 'Liste des objects',
					name: 'NOM',
					color: 'couleur',
					del: 'suppr.',
					drawPoint: 'Cliquez sur la carte pour ajouter un point',
					drawLine: 'Cliquez sur la carte pour ajouter une ligne',
					drawPolygon: 'Cliquez sur la carte pour ajouter un polygone',
					dlTitle: 'Télécharger fichier geojson',
					dl: 'Télécharger',
					upTitle: 'Charger un fichier geojson'
				},
				confirmPoint : {
					nameText: 'Nommez ce point',
					namePlaceholder: 'Nom',
					colorText: 'Couleur du marqueur',
					confirm: 'OK',
					cancel: 'Annuler'
				},
				confirmLine : {
					nameText: 'Nommez cette ligne',
					namePlaceholder: 'Nom',
					colorText: 'Couleur',
					confirm: 'OK',
					cancel: 'Annuler'
				...
				edit: {
					titleName: 'Modifier le nom de cet object:',
					name: 'NOM',
					newname: 'Nouveau nom',
					cancel: 'Annuler',
					okName: 'Changer le nom',
					titleCol: 'Modifier la couleur de cet objet:',
					okCol: 'Changer la couleur'
				},
				changeName: {
					title: 'Modifier le nom de cet object:',
					name: 'NOM',
					newname: 'Nouveau nom',
					cancel: 'Annuler',
					ok: 'Changer le nom'
				...
				changeStyle: {
					title: 'Modifier la couleur de cet objet:',
					name: 'NOM',
					cancel: 'Annuler',
					ok: 'Changer la couleur'
				}
			} 
		}
	}
...
},{"./lib/pages.js":4,"browserify-zepto":9,"director":10}],9:[function(require,module,exports){
